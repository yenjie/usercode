...
TH1D* hEta_UA5 = new TH1D("hEta_UA5","hEta_UA5",600,-3.,3.);
...
TH1D *getUA5NSD()
{
 TH1D* hEta_UA5_NSD = new TH1D("hEta_UA5_NSD",";#eta;dN/d#eta",
50,-3,3);
...
TH1D *getUA5NSDScaled()
{
 TH1D* hEta_UA5_NSD = new TH1D("hEta_UA5_NSDScale",";#eta;dN/d#eta", 50,-3,3);
   //scaleFactor = 1.23625;
