...
//   TFile *fCorrectionExternal = new TFile(Form("correction/correction-%d-ATLAS-7TeV-HF1.root",TrackletType));
   ...
   const int nTrackletBin =8;// myCut.nTrackletBin;
...
//   double TrackletBins[nTrackletBin+1] = {-5,2,4,6,8,10,15,20,25,30,35,40,45,50,300};
   ...
   double TrackletBins[nTrackletBin+1] = {-100,50,100,400,1000,2000,4000,8000,20000};
   ...
   double sideBandRegionCut = 1.0;    //delta phi cut for sideband
...
//   hReproducedBackground->Scale(sideBandRegionCut/signalRegionCut-1.);
   // Read Acceptance ==================================================================================================
