...
void plotDataDrivenEff(int TrackletType=12, double type=1)
{
   // data input
   ...
   TCut dataCut = "l1TBit[4]!=0&&l1TBit[36]!=1&&l1TBit[37]!=1&&l1TBit[38]!=1&&l1TBit[39]!=1&&l1TBit[0]==1&&vtxQualCut==1&&vz[1]>-99";
   TCut MCCutNoVtxCut = "l1TBit[36]!=1&&l1TBit[37]!=1&&l1TBit[38]!=1&&l1TBit[39]!=1";
   TCut MCCut = "l1TBit[36]!=1&&l1TBit[37]!=1&&l1TBit[38]!=1&&l1TBit[39]!=1&&vz[1]>-99";
   TCut HFCut;
   ...
   tData->Draw("mult>>hDataHFCut",dataCut&&HFCut);
   tData->Draw("mult>>hData",dataCut);
   tMC->Draw("mult>>hMCHFCut",MCCut&&HFCut);
   tMC->Draw("mult>>hMC",MCCut);
   tMCPHOJET->Draw("mult>>hMCPHOJETHFCut",MCCut&&HFCut);
   tMCPHOJET->Draw("mult>>hMCPHOJET",MCCut);
