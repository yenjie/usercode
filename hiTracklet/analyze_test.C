...
//       double DataPdf = TMath::Gaus(myVz,-0.4623,2.731,1);
    ...
    */
     recoTracklets12 = recoProtoTracklets(layer1,layer2);
     recoTracklets13 = recoProtoTracklets(layer1,layer3);
     recoTracklets23 = recoProtoTracklets(layer2,layer3);
