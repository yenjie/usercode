...
bool QPythiaHadronizer::readSettings( int )
{
...
//_____________________________________________________________________
bool QPythiaHadronizer::pyqpythia_init(const ParameterSet & pset)
{
...
bool QPythiaHadronizer::pyquen_init(const ParameterSet &pset)
{
...
/*
  ...
  string qpDataName = qpData.fullPath();
  memset(QOPTIONS.fileinput,' ',4096);
  strcpy(QOPTIONS.fileinput,qpDataName.c_str());
  QOPTIONS.fileinput[strlen(QOPTIONS.fileinput)] = ' ';
*/
  cout<<"======"<<endl;
//  cout<<qpDataName.data()<<endl;
  cout<<"======"<<endl;
...
const char* QPythiaHadronizer::nucleon(){
  int* dummy = 0;
...
void QPythiaHadronizer::rotateEvtPlane(HepMC::GenEvent* evt, double angle){
