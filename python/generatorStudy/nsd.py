...
#process.load('Configuration.GenProduction.PYTHIA6_MinBias_ATLASCSC_7TeV_cff')
...
#process.load('Configuration.GenProduction.PYTHIA6_MinBiasX1_900GeV_cff')
#process.load('Configuration.GenProduction.PYTHIA6_MinBiasX2_7TeV_cff')
process.load('Configuration.GenProduction.MinBias_7TeV_pythia8_cff')
