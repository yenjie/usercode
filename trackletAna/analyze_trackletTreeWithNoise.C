...
void analyze_trackletTreeWithNoise(char * infile, char * outfile =
"output.root", int nNoise1 = 1, int nNoise2 = 0 ){
...
//  trackletTree->Branch("phi",tdata.phi,"phi[npart]/F");
  ...
  for(int i = 0; i< t->GetEntries(); ++i){    
    ...
    for (int n=0;n<nNoise1;n++) {
       layer1.push_back(RandomHit(-2.5,2.5,-3.1415926,3.1415926));    
    }
    double mult = 0;
    ...
    for (int n=0;n<nNoise2;n++) {
       layer2.push_back(RandomHit(-2.5,2.5,-3.1415926,3.1415926));    
    }
