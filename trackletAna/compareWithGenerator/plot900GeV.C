...
#include "plot-900GeV/plot-900GeV-ATLAS.C"
#include "plot-900GeV/plot-900GeV-D6T.C"
#include "plot-2.36TeV/plot-2.36TeV-ATLAS.C"
#include "plot-2.36TeV/plot-2.36TeV-D6T.C"
...
//=========  (Thu Dec 10 11:52:00 2009) by ROOT version5.22/00d
   ...
   */
   ...
   TH1F *hATLAS = getPlot900GeVATLAS();
   hATLAS->SetLineColor(4);
   hATLAS->SetMarkerColor(4);
   hATLAS->SetMarkerStyle(22);
   hATLAS->Draw("same");

   TH1F *hD6T = getPlot900GeVD6T();
   hD6T->SetLineColor(4);
   hD6T->SetMarkerColor(4);
   hD6T->SetMarkerStyle(21);
   hD6T->Draw("same");

   TH1F *hATLAS2360 = getPlot2360GeVATLAS();
   hATLAS2360->SetLineColor(4);
   hATLAS2360->SetMarkerColor(4);
   hATLAS2360->SetMarkerStyle(26);
   hATLAS2360->Draw("same");

   TH1F *hD6T2360 = getPlot23600GeVD6T();
   hD6T2360->SetLineColor(4);
   hD6T2360->SetMarkerColor(4);
   hD6T2360->SetMarkerStyle(25);
   hD6T2360->Draw("same");

   
   leg->AddEntry(hATLAS,"","P");
   leg->AddEntry(hD6T,"","P");
   ...
   leg2->AddEntry(hATLAS2360,"ATLAS Tune","p");
   leg2->AddEntry(hD6T2360,"D6T Tune","p");
