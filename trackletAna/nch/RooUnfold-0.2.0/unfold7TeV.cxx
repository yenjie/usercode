...
//    TFile *inf = new TFile("TrackletTree-ATLAS-new.root");
    TFile *inf = new TFile("TrackletTree-D6T-7TeV.root");
...
//  TFile *inf3 = new TFile("TrackletTree-900GeV-D6T.root");
  ...
  TTree *t3 = (TTree*)inf3->FindObjectAny("TrackletTree12");
  

  TFile *inf4 = new TFile("TrackletTree-ATLAS-new.root");
  TTree *t4 = (TTree*)inf4->FindObjectAny("TrackletTree12");
...
//  leg1->AddEntry(h,"UA5 900GeV |#eta|<1.5","pl");
  ...
  leg1->AddEntry(hMC,"MC D6T 7TeV","pl");
  leg1->AddEntry(hMCATLAS,"MC ATLAS 7TeV","pl");
