...
double RxCalculator::getRx(const reco::SuperCluster* cluster, double x, double threshold )
{
   using namespace edm;
   using namespace reco;
...
double RxCalculator::getROx(const reco::SuperCluster* cluster, double x,double threshold)
{
   using namespace edm;
   using namespace reco;
...
double RxCalculator::getRFx(const reco::SuperCluster* cluster, double x, double threshold)
{
   using namespace edm;
   using namespace reco;
...
double RxCalculator::getCRx(const reco::SuperCluster* cluster, double x, double threshold )
{
   using namespace edm;
   using namespace reco;
